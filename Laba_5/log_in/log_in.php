                ...
                <div class="menu">
                    <div class="menu-box">
                        <ul class="main-menu">
                            ...
                            <li><a href="log_in.php">Вхід</a></li>
                        </ul>
                    </div>
                </div>
                <div class="big-block">
                    ...
                    <div class="mini-block">
                        <div class="content">
                               <form name="formUser" class="form-group" action="form_analiz.php" method="post">
                                    
                                        <input autofocus class="form-control" name="username" placeholder="Ім'я" type="text"/><br>
