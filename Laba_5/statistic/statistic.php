            ...
            <div class="main-part">
                ...
                <div class="big-block">
                    ...
                    <div class="mini-block">
                        <div class="content">
                                <form name="formUser" class="form-group" onsubmit="return validateForm()">
                                        <center>
                                        <input autofocus class="form-control" name="username" placeholder="��'�" type="text"/><br>
                                        <input autofocus class="form-control" name="usermail" placeholder="email" type="email"/><br>
                                        <input class="form-control" name="password" placeholder="������" type="password"/><br>
